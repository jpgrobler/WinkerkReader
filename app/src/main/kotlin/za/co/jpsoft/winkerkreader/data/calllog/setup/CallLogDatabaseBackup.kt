...
import za.co.jpsoft.winkerkreader.data.calllog.setup.CallLogDatabaseBackup.DEBOUNCE_MS
import za.co.jpsoft.winkerkreader.data.calllog.setup.CallLogDatabaseBackup.backupDebounced
import za.co.jpsoft.winkerkreader.data.calllog.setup.CallLogDatabaseBackup.backupNow
import za.co.jpsoft.winkerkreader.data.members.provider.WinkerkContract.winkerkEntry
import za.co.jpsoft.winkerkreader.utils.db.DatabaseBackupHelper
import za.co.jpsoft.winkerkreader.utils.prefs.BackupPrefs
import java.io.File

/**
 * Mirrors [za.co.jpsoft.winkerkreader.utils.db.PastoralDatabaseBackup] for the
 * call-log database.
 *
