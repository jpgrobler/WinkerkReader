...
import za.co.jpsoft.winkerkreader.utils.ChecksumSocketTransfer.downloadByGuid
import za.co.jpsoft.winkerkreader.utils.ChecksumSocketTransfer.downloadOverConnectedSockets
...
object ChecksumSocketTransfer {
    ...
    private suspend fun receiveChunks(
        ...
        while (totalReceived < fileSize) {
            if (!isActive()) {
                throw java.util.concurrent.CancellationException("Transfer cancelled")
            }
