...
class WhatsAppNotificationService : NotificationListenerService() {
    ...
    private fun initialize() {
        ...
        // Build VoIP package map (same as before)
        ...
        // Create the tracker and handler
    ...
    // -------------------------------------------------------------------------
    // Notification gate (keep this simple – can be moved to a separate class later)
    // -------------------------------------------------------------------------
    ...
    private fun looksLikeCallNotification(sbn: StatusBarNotification): Boolean {
        ...
        val detector = VoipCallStateDetector()
        return detector.isCallEndedNotification(title, text, bigText, subText) ||
                detector.isMissedCall(title, text, bigText, subText) ||
                detector.isIncomingCall(title, text, bigText, subText) ||
                detector.isPossibleOutgoingCall(title, text, bigText, subText)
    }
    ...
    // -------------------------------------------------------------------------
    // Diagnostics (kept for debugging)
    // -------------------------------------------------------------------------
