...
// ─── Quick Action Toggles ──────────────────────────────────────────────────
    ...
    // Flip: now false = show quick actions (default)
    var showQuickActionBar: Boolean
        get() = prefs.getBoolean("showQuickActionBar", true)   // default false → show quick actions
    ...
    var quickActionMore: Boolean
        get() = prefs.getBoolean(
            "quick_action_more",
            true
        )   // always show "Meer" to reach full menu
