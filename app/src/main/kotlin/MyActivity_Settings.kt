 ...
 */
class MyActivity_Settings : ListActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listAdapter = MyActivity_Settings_Adapter(this, R.layout.sub_menu_item, settingList)
    }

    override fun onSaveInstanceState(outState: Bundle) {
        super.onSaveInstanceState(outState)
        outState.putParcelableArrayList(MainActivity2.SEARCH_CHECK_BOX, settingList)
    }
 ...
 */
class MyActivity_Settings_Adapter(
