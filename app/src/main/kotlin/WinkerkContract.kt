...
object WinkerkContract {
    ...
    object winkerkEntry : BaseColumns {
        ...
        @JvmField var OPROEPMONITOR = true
        @JvmField var DEFLAYOUT = "GESIN"
        @JvmField var EPOSHTML = false

        @JvmField var SORTORDER = "VAN"
        @JvmField var SOEK = "A"
        @JvmField var DETAIL = false
        @JvmField var LIDMAATID = 0
        @JvmField var LIDMAATGUID = ""
        @JvmField var GESINNGUID = ""
        @JvmField var SOEKLIST = false
        @JvmField var LOADER = ""
        @JvmField var GEMEENTE_NAAM = ""
        @JvmField var GEMEENTE_EPOS = ""
        @JvmField var GEMEENTE_KLEUR = 0
        @JvmField var GEMEENTE2_NAAM = ""
        @JvmField var GEMEENTE2_EPOS = ""
        @JvmField var GEMEENTE2_KLEUR = 0
        @JvmField var GEMEENTE3_NAAM = ""
        @JvmField var GEMEENTE3_EPOS = ""
        @JvmField var GEMEENTE3_KLEUR = 0
        @JvmField var id = ""
        @JvmField var RECORDSTATUS = "0"
        @JvmField var GROEP_SMS_NAAM = ""
        @JvmField var DATA_DATUM = ""

        @JvmField var LIST_FOTO = true
        @JvmField var LIST_VERJAARBLOK = true
        @JvmField var LIST_HUWELIKBLOK = true
        @JvmField var LIST_WYK = true
        @JvmField var LIST_WHATSAPP = true
        @JvmField var LIST_EPOS = true
        @JvmField var LIST_OUDERDOM = true
        @JvmField var LIST_SELFOON = true
        @JvmField var LIST_TELEFOON = true

        @JvmField var WHATSAPP1 = true
        @JvmField var WHATSAPP2 = true
        @JvmField var WHATSAPP3 = true

        @JvmField var KEUSE = "Verjaar"

        @JvmField var WIDGET_DOOP = true
        @JvmField var WIDGET_BELYDENIS = true
        @JvmField var WIDGET_HUWELIK = true
        @JvmField var WIDGET_STERF = true
        ...
        @JvmField val SELECTION_LIDMAAT_WIDGET =
            "SELECT Members._rowid_ as _id, " +
                    ...
                    "date(SUBSTR(" + WinkerkContract.col(LIDMATE_GEBOORTEDATUM) + ", 7) || '-' || SUBSTR(" + WinkerkContract.col(LIDMATE_GEBOORTEDATUM) + ", 4, 2) || '-' || SUBSTR(" + WinkerkContract.col(LIDMATE_GEBOORTEDATUM) + ", 1, 2)) AS birthdate, " +
        ...
        @JvmField var SELECTION_LIDMAAT_WHERE =
            " (" + LIDMATE_TABLE_NAME + "." + WinkerkContract.col(LIDMATE_REKORDSTATUS) + " = " + RECORDSTATUS + " )"
        ...
        @JvmField var LISTVIEW = 2
        @JvmField var GROEPVIEW = GROEPLIST_LOADER
