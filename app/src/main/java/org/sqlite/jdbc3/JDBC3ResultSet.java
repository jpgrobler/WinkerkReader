...
public abstract class JDBC3ResultSet extends CoreResultSet {
        ...
        switch(db.column_type(stmt.pointer, markCol(col))) {
            ...
            case SQLITE_TEXT:
                try {
                    ...
                    SQLException error = new SQLException("Error parsing date", e);
        ...
        switch (db.column_type(stmt.pointer, markCol(col))) {
            ...
            case SQLITE_TEXT:
                try {
                    ...
                    SQLException error = new SQLException("Error parsing time stamp", e);
        ...
        switch (db.column_type(stmt.pointer, markCol(col))) {
            ...
            case SQLITE_TEXT:
                try {
                    ...
                    SQLException error = new SQLException("Error parsing time", e);
    ...
    public void checkCalendar(Calendar cal) throws SQLException {
        ...
        SQLException e = new SQLException("Expected a calendar instance.", new NullPointerException());
