...
public class SQLiteMCConfig extends SQLiteConfig {
    ...
    protected SQLiteMCConfig setCipher(CipherAlgorithm cipherAlgorithm) {
        setPragma(Pragma.CIPHER, cipherAlgorithm.getValue());
        return this;
    }
    ...
    protected SQLiteMCConfig setLegacy(int value) {
        setPragma(Pragma.LEGACY, String.valueOf(value));
        return this;
    }
    ...
    protected SQLiteMCConfig setKdfIter(int value) {
        setPragma(Pragma.KDF_ITER, String.valueOf(value));
        return this;
    }

    protected SQLiteMCConfig setFastKdfIter(int value) {
        setPragma(Pragma.FAST_KDF_ITER, String.valueOf(value));
        return this;
    }

    protected SQLiteMCConfig setHmacUse(boolean value) {
        setPragma(Pragma.HMAC_USE, String.valueOf(value ? 1 : 0));
        return this;
    }

    protected SQLiteMCConfig setHmacPgno(HmacPgno value) {
        setPragma(Pragma.HMAC_PGNO, String.valueOf(value.ordinal()));
        return this;
    }

    protected SQLiteMCConfig setHmacSaltMask(int value) {
        setPragma(Pragma.HMAC_SALT_MASK, String.valueOf(value));
        return this;
    }

    protected SQLiteMCConfig setKdfAlgorithm(KdfAlgorithm value) {
        setPragma(Pragma.KDF_ALGORITHM, String.valueOf(value.ordinal()));
        return this;
    }

    protected SQLiteMCConfig setHmacAlgorithm(HmacAlgorithm value) {
        setPragma(Pragma.HMAC_ALGORITHM, String.valueOf(value.ordinal()));
        return this;
    }

    protected SQLiteMCConfig setPlaintextHeaderSize(int value) {
        setPragma(Pragma.PLAINTEXT_HEADER_SIZE, String.valueOf(value));
        return this;
    }
